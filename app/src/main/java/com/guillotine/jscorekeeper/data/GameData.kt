...
fun processGameData(applicationContext: Context, gameMode: GameModes): GameData {
    val rounds = when (gameMode) {
        ...
        GameModes.US_CELEB -> applicationContext.resources.getIntArray(R.array.us_celeb_round_multiplier)
    ...
    val columns = when (gameMode) {
        ...
        GameModes.US_CELEB -> applicationContext.resources.getInteger(R.integer.us_celeb_columns)
    ...
    val moneyValues = when (gameMode) {
        ...
        GameModes.US_CELEB -> applicationContext.resources.getIntArray(R.array.us_celeb_money)
    ...
    val currency = when (gameMode) {
        ...
        GameModes.US_CELEB -> applicationContext.resources.getString(R.string.us_celeb_currency)
